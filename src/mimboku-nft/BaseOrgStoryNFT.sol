...
abstract contract BaseOrgStoryNFT is IOrgStoryNFT, BaseStoryNFT {
    ...
    constructor(address derivativeWorkflows, address upgradeableBeacon) BaseStoryNFT(derivativeWorkflows) {
    ...
    function initialize(uint256 orgTokenId_, address orgIpId_, StoryNftInitParams calldata initParams)
        external
        virtual
        initializer
    {
    ...
    /// @param orgIpId_ The ID of the organization IP.
    /// @param initParams The initialization parameters for StoryNFT {see {IStoryNFT-StoryNftInitParams}}.
    function __BaseOrgStoryNFT_init(uint256 orgTokenId_, address orgIpId_, StoryNftInitParams calldata initParams)
        internal
        onlyInitializing
    {
